 ...
 * C source code generated on : Fri Mar  7 10:28:45 2025
 *
...
void MagneticLevitation_Template_step(void)
{
  ...
  if (MagneticLevitation_Template_M->Timing.t[0] <
    ...
    MagneticLevitation_Template_B.Step = MagneticLevitation_Template_P.Step_Y0;
  } else {
    MagneticLevitation_Template_B.Step =
...
void MagneticLevitation_Template_initialize(void)
{
  ...
  /* External mode info */
  MagneticLevitation_Template_M->Sizes.checksums[0] = (354797091U);
  MagneticLevitation_Template_M->Sizes.checksums[1] = (235364823U);
  MagneticLevitation_Template_M->Sizes.checksums[2] = (1345525197U);
  MagneticLevitation_Template_M->Sizes.checksums[3] = (2396127676U);
  ...
  /* block I/O */
  {
    ...
    MagneticLevitation_Template_B.Step = 0.0;
  }
