...
%%
addpath('function')
add_data_volt('/test_controllore/controllore_el/sine_test/25_03_2025');
...
T_end = dt(end);
out = sim("validation_frequency_controller.slx");
figure();
hold on;
...
omega = 20;
[mag1, phase1] = prova(1.045, 0.005, omega);
...
omega = 30;
[mag1, phase1] = prova(1.05875, 0.006, omega);
...
omega = 40;
[mag1, phase1] = prova(1.0625, 0.0067, omega);
...
omega = 50;
[mag1, phase1] = prova(1.055, 0.007, omega);
...
omega = 90;
[mag1, phase1] = prova(0.77, 0.0075, omega);
...
omega = 100;
[mag1, phase1] = prova(0.72, 0.01, omega);
...
omega = 120;
[mag1, phase1] = prova(0.675, 0.007, omega);
...
omega = 129;
[mag1, phase1] = prova(0.65, 0.0071, omega);
...
omega = 140;
[mag1, phase1] = prova(0.58, 0.0072, omega);
...
%validation(S_Test_wb_10V_30radS, 10, 30);
omega = 150;
[mag1, phase1] = prova(0.56, 0.007, omega);
...
%validation(S_Test_wb_10V_30radS, 10, 30);
omega = 400;
[mag1, phase1] = prova(0.22, 0.005, omega);
...
%validation(S_Test_wb_10V_30radS, 10, 30);
omega = 300;
[mag1, phase1] = prova(0.28, 0.007, omega);
...
%validation(S_Test_wb_10V_30radS, 10, 30);
omega = 345;
[mag1, phase1] = prova(0.25, 0.006, omega);
