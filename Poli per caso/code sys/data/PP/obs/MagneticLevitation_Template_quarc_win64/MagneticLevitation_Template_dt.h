...
static DataTypeTransition rtBTransitions[] = {
  { (char_T *)(&MagneticLevitation_Template_B.StateSpace[0]), 0, 0, 19 }
  ,
  ...
  { (char_T *)(&MagneticLevitation_Template_DW.RandSeed), 7, 0, 3 }
};
...
static DataTypeTransition rtPTransitions[] = {
  { (char_T *)(&MagneticLevitation_Template_P.A_ob[0]), 0, 0, 40 },
  ...
  { (char_T *)(&MagneticLevitation_Template_P.ManualSwitch3_CurrentSetting), 3,
    0, 64 }
};
