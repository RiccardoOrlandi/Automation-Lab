...
typedef RT_MODEL_MagneticLevitation_T_T RT_MODEL;

/*====================*
 * External functions *
 *====================*/
EXTERN RT_MODEL * MagneticLevitation_Template(void);

/* A global buffer for storing error messages (defined in quanser_common library) */
EXTERN char _rt_error_message[512];

/*
   extern void MagneticLevitation_Template_initialize();
   extern void MagneticLevitation_Template_terminate();
 */
...
static void rtExtModeSingleTaskUpload(RT_MODEL * S)
{
  {                                    /* Sample time: [0.0s, 0.0s] */
    rtExtModeUpload(0, MagneticLevitation_Template_M->Timing.t[0]);
  }

  if (rtmIsMajorTimeStep(MagneticLevitation_Template_M)) {/* Sample time: [0.002s, 0.0s] */
    rtExtModeUpload(1, (((MagneticLevitation_Template_M->Timing.clockTick1+
  ...
  _do_assertion(const char * expression, const char * file_name, int line_number)
{
  ...
  rtmSetErrorStatus(MagneticLevitation_Template_M, GBLbuf.message);
}
...
static void rt_OneStep(RT_MODEL *S)
{
  ...
  MagneticLevitation_Template_step();
  ...
  main(int argc, char * argv[])
{
  ...
  rtExtModeQuarcParseArgs(argc, (const char **) argv,
    "shmem://MagneticLevitation_Template:1");
  ...
  if (parseError) {
    (void) fprintf(stderr,
                   "\nUsage: MagneticLevitation_Template -option1 val1 -option2 val2 -option3 ...\n\n");
    (void) fprintf(stderr,
   ...
   ************************/
  MagneticLevitation_Template_initialize();
  S = MagneticLevitation_Template_M;
  ...
  MagneticLevitation_Template_terminate();
