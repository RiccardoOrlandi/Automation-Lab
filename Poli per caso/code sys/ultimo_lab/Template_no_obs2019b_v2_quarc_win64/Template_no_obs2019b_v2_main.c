...
typedef RT_MODEL_Template_no_obs2019b_T RT_MODEL;

/*====================*
 * External functions *
 *====================*/
EXTERN RT_MODEL * Template_no_obs2019b_v2(void);

/* A global buffer for storing error messages (defined in quanser_common library) */
EXTERN char _rt_error_message[512];

/*
   extern void Template_no_obs2019b_v2_initialize();
   extern void Template_no_obs2019b_v2_terminate();
 */
...
static void rtExtModeSingleTaskUpload(RT_MODEL * S)
{
  {                                    /* Sample time: [0.0s, 0.0s] */
    rtExtModeUpload(0, Template_no_obs2019b_v2_M->Timing.t[0]);
  }

  if (rtmIsMajorTimeStep(Template_no_obs2019b_v2_M)) {/* Sample time: [0.002s, 0.0s] */
    rtExtModeUpload(1, (((Template_no_obs2019b_v2_M->Timing.clockTick1+
  ...
  _do_assertion(const char * expression, const char * file_name, int line_number)
{
  ...
  rtmSetErrorStatus(Template_no_obs2019b_v2_M, GBLbuf.message);
}
  ...
  main(int argc, char * argv[])
{
  ...
  rtExtModeQuarcParseArgs(argc, (const char **) argv,
    "shmem://Template_no_obs2019b_v2:1");
  ...
  if (parseError) {
    (void) fprintf(stderr,
                   "\nUsage: Template_no_obs2019b_v2 -option1 val1 -option2 val2 -option3 ...\n\n");
    (void) fprintf(stderr,
   ...
   ************************/
  Template_no_obs2019b_v2_initialize();
  S = Template_no_obs2019b_v2_M;
  ...
  Template_no_obs2019b_v2_terminate();
